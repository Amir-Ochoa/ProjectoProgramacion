...
public class InterfazEE extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label experienciaLabel = new Label("Experiencia");
        ...
        HBox filterAddBox = new HBox(10,  experienciaLabel, buscarField, filtrarButton, agregarButton);
    ...
    private void mostrarVentanaUsuario(Stage currentStage) {
        currentStage.close();
        Stage acd = new Stage();
        UsuarioInerfaz ventanaAcademia = new UsuarioInerfaz();
        ventanaAcademia.start(acd);
